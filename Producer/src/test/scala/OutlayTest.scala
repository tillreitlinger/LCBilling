...
class OutlayTest extends AnyWordSpec with Matchers{
  ...
  "The function 'from' should return a scala.Outlay object with Paul, if 'Paul' is passed" in{
    val result_outlay = Outlay(Some("Paul"), None, None, None)
    outlay from "Paul" should be(result_outlay)
  }
  "The function 'towards' should return a scala.Outlay object with 'Martin, Till', if 'Martin, Till' is passed" in{
    val result_outlay = Outlay(None, Some(Seq("Martin","Till")), None, None)
    outlay towards List("Martin","Till") should be(result_outlay)
  }
  "The function 'of' should return a scala.Outlay object with '100', if '100.EUR' is passed" in{
    val result_outlay = Outlay(None, None, Some(100), None)
    outlay of 100.EUR should be(result_outlay)
  }
  "The function 'of' should return a scala.Outlay object with '92', if '100.CHF' is passed" in{
    val result_outlay = Outlay(None, None, Some(93), None)
    outlay of 100.CHF should be(result_outlay)
  }
  "The function 'at' should return a scala.Outlay object with 'supermarket', if 'supermarket' is passed" in{
    val result_outlay = Outlay(None, None, None, Some("Supermarket"))
    outlay at "Supermarket" should be(result_outlay)
  }
  "The function chain should return a scala.Outlay object" in{
